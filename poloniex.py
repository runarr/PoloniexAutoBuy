...
class Poloniex:
    ...
    # Outputs: 
    # orderNumber   The order number
    def buy(self,currencyPair,rate,amount,immediateOrCancel):
        return self.api_query('buy',{"currencyPair":currencyPair,"rate":rate,"amount":amount,"immediateOrCancel":immediateOrCancel})
